export function GoogleButton() {
  return (
    <button
      type="button"
      className="flex h-[52px] w-full items-center justify-center gap-3 rounded-lg border border-white/12 bg-white/[0.03] font-body text-[15px] font-medium text-ink transition-colors duration-150 hover:bg-white/[0.06]"
    >
