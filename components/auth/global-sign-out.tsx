...
export function GlobalSignOut() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="fixed right-4 top-20 z-[100] flex items-center gap-1.5 rounded-full border border-ink/12 bg-canvas/90 px-3 py-2 font-mono text-[11px] uppercase tracking-wider text-ink-faint shadow-[0_4px_20px_-6px_rgba(0,0,0,0.25)] backdrop-blur-md transition-colors hover:border-accent/40 hover:text-ink disabled:opacity-50 sm:right-6 sm:top-24"
    >
